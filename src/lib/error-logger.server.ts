...
//
// Lives in a separate file from initErrorLogger because `next/server` cannot
// be imported by client-bundled code. The `import 'server-only'` directive
// makes any accidental client import fail loudly at build time.
//
